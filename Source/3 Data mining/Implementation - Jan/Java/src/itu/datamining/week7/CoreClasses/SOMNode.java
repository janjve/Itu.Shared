...
package itu.datamining.week7.CoreClasses;
...
public class SOMNode {
	...
	public void adjustWeights(SOMVector input, double learningRate, double distanceInfluence)
	{
		for(int i = 0; i < weights.size(); i++){
			double currentWeight = (double) weights.elementAt(i);
			double newWeight = currentWeight+ learningRate*distanceInfluence*((double)input.elementAt(i)-currentWeight);
		}
	}
}