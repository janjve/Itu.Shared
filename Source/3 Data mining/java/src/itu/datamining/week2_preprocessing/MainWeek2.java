...
public class MainWeek2 {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            String[][] result = DataCleaning.selectFrom(data,
            ...
            DataCleaning.trimTrailingValues(result, "\"Favorite game?\"");

            ResultPrinter.printHeader("Trimmed Favorite Game");
            ResultPrinter.printResult(result, !SKIP_HEADER_ROW);

            DataCleaning.convertLettersToNumbers(result, "\"Which row are you sitting/did you sit in during the introduction lecture? \"");
