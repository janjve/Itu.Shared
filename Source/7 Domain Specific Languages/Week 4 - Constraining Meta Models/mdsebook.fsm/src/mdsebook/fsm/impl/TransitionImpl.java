 ...
 * </p>
 * <ul>
 *   <li>{@link mdsebook.fsm.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link mdsebook.fsm.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link mdsebook.fsm.impl.TransitionImpl#getInput <em>Input</em>}</li>
 *   <li>{@link mdsebook.fsm.impl.TransitionImpl#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setSource(State newSource) {
		if (newSource != eInternalContainer() || (eContainerFeatureID() != FsmPackage.TRANSITION__SOURCE && newSource != null)) {
			...
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, FsmPackage.STATE__LEAVING_TRANSITIONS, State.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FsmPackage.TRANSITION__SOURCE:
				return eInternalContainer().eInverseRemove(this, FsmPackage.STATE__LEAVING_TRANSITIONS, State.class, msgs);
		}
