...
lazy val root = (project in file(".")).settings (
  ...
  unmanagedSourceDirectories in Compile += baseDirectory.value / "../mdsebook.printers/src/",
  // include the EMFScala "framework" (there is probably a better way to do it, to avoid rebuilding)
  unmanagedSourceDirectories in Compile += baseDirectory.value / "../mdsebook.scala/src/main/scala",
