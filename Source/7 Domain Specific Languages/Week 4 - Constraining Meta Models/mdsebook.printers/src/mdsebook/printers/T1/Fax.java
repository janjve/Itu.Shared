 ...
 * </p>
 * <ul>
 *   <li>{@link mdsebook.printers.T1.Fax#getPool <em>Pool</em>}</li>
 * </ul>
 *
 * @see mdsebook.printers.T1.T1Package#getFax()
 * @model
 * @generated
 */
public interface Fax extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link mdsebook.printers.T1.PrinterPool#getFax <em>Fax</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see mdsebook.printers.T1.T1Package#getFax_Pool()
	...
	/**
	 * Sets the value of the '{@link mdsebook.printers.T1.Fax#getPool <em>Pool</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
