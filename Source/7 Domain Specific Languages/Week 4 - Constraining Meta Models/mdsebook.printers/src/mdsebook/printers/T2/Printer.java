 ...
 * </p>
 * <ul>
 *   <li>{@link mdsebook.printers.T2.Printer#getPool <em>Pool</em>}</li>
 * </ul>
 *
 * @see mdsebook.printers.T2.T2Package#getPrinter()
 * @model
 * @generated
 */
public interface Printer extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link mdsebook.printers.T2.PrinterPool#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see mdsebook.printers.T2.T2Package#getPrinter_Pool()
	...
	/**
	 * Sets the value of the '{@link mdsebook.printers.T2.Printer#getPool <em>Pool</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
