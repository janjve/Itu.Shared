 ...
 * </p>
 * <ul>
 *   <li>{@link mdsebook.printers.T2.impl.FaxImpl#getPool <em>Pool</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FaxImpl extends MinimalEObjectImpl.Container implements Fax {
	...
	public PrinterPool getPool() {
		if (eContainerFeatureID() != T2Package.FAX__POOL) return null;
	...
	public NotificationChain basicSetPool(PrinterPool newPool, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPool, T2Package.FAX__POOL, msgs);
		return msgs;
	}
	...
	public void setPool(PrinterPool newPool) {
		if (newPool != eInternalContainer() || (eContainerFeatureID() != T2Package.FAX__POOL && newPool != null)) {
			...
			if (newPool != null)
				msgs = ((InternalEObject)newPool).eInverseAdd(this, T2Package.PRINTER_POOL__FAX, PrinterPool.class, msgs);
			msgs = basicSetPool(newPool, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, T2Package.FAX__POOL, newPool, newPool));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case T2Package.FAX__POOL:
				return eInternalContainer().eInverseRemove(this, T2Package.PRINTER_POOL__FAX, PrinterPool.class, msgs);
		}
