 ...
 * </p>
 * <ul>
 *   <li>{@link mdsebook.printers.T2.impl.PrinterImpl#getPool <em>Pool</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrinterImpl extends MinimalEObjectImpl.Container implements Printer {
	...
	protected EClass eStaticClass() {
		return T2Package.Literals.PRINTER;
	}
	...
	public PrinterPool getPool() {
		if (eContainerFeatureID() != T2Package.PRINTER__POOL) return null;
	...
	public NotificationChain basicSetPool(PrinterPool newPool, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPool, T2Package.PRINTER__POOL, msgs);
		return msgs;
	}
	...
	public void setPool(PrinterPool newPool) {
		if (newPool != eInternalContainer() || (eContainerFeatureID() != T2Package.PRINTER__POOL && newPool != null)) {
			...
			if (newPool != null)
				msgs = ((InternalEObject)newPool).eInverseAdd(this, T2Package.PRINTER_POOL__PRINTER, PrinterPool.class, msgs);
			msgs = basicSetPool(newPool, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, T2Package.PRINTER__POOL, newPool, newPool));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case T2Package.PRINTER__POOL:
				return eInternalContainer().eInverseRemove(this, T2Package.PRINTER_POOL__PRINTER, PrinterPool.class, msgs);
		}
