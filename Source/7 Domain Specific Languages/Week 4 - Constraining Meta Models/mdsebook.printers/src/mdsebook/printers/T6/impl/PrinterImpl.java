 ...
 * </p>
 * <ul>
 *   <li>{@link mdsebook.printers.T6.impl.PrinterImpl#getPool <em>Pool</em>}</li>
 *   <li>{@link mdsebook.printers.T6.impl.PrinterImpl#isColor <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrinterImpl extends MinimalEObjectImpl.Container implements Printer {
	...
	protected EClass eStaticClass() {
		return T6Package.Literals.PRINTER;
	}
	...
	public PrinterPool getPool() {
		if (eContainerFeatureID() != T6Package.PRINTER__POOL) return null;
	...
	public NotificationChain basicSetPool(PrinterPool newPool, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPool, T6Package.PRINTER__POOL, msgs);
		return msgs;
	}
	...
	public void setPool(PrinterPool newPool) {
		if (newPool != eInternalContainer() || (eContainerFeatureID() != T6Package.PRINTER__POOL && newPool != null)) {
			...
			if (newPool != null)
				msgs = ((InternalEObject)newPool).eInverseAdd(this, T6Package.PRINTER_POOL__PRINTER, PrinterPool.class, msgs);
			msgs = basicSetPool(newPool, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, T6Package.PRINTER__POOL, newPool, newPool));
	}
	...
	public void setColor(boolean newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, T6Package.PRINTER__COLOR, oldColor, color));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case T6Package.PRINTER__POOL:
				return eInternalContainer().eInverseRemove(this, T6Package.PRINTER_POOL__PRINTER, PrinterPool.class, msgs);
		}
