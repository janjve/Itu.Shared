/**
 */
package mdsebook.printers.T6.util;
 ...
 * @generated
 */
public class T6Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static T6Package modelPackage;
	...
	public T6Switch() {
		if (modelPackage == null) {
			modelPackage = T6Package.eINSTANCE;
		}
	}
