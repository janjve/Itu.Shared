...
public class TestCache {
  public static void main(String[] args) throws InterruptedException {
    ...
    System.out.println("calls: " + factorizer.getCount());
    System.out.println("runtime: " + ((end-start)/1_000_000) + " ms.");
  }

  private static void exerciseFactorizer(Computable<Long, long[]> f) {
    System.out.println(f.getClass());
    final long threadCount = 16;
    final long start = 10_000_000_000L, range = 20_000L;

    final long perThread = range / threadCount;
